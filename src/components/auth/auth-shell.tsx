...
export default function AuthShell() {
  return (
    <div className="w-full max-w-lg mx-auto">
      <div
        className="rounded-2xl shadow-xl backdrop-blur-md bg-card/90 p-6 sm:p-8 md:p-10 border border-border overflow-hidden"
        style={{
          boxShadow:
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">خوش آمدید</h1>
