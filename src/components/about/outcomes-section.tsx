...
export function OutcomesSection() {
  const outcomes = [
    {
      title: "شفافیت کامل",
      description: "شما همیشه در جریان پیشرفت کار هستید"
    },
    {
      title: "نتیجه قابل اتکا",
      description: "تحویل به موقع با کیفیت بالا"
    },
    {
      title: "ارزش واقعی",
      description: "راه‌حل‌هایی که واقعاً کار می‌کنند"
    }
  ];
