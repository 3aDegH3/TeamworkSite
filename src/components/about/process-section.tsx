...
import { Search, Palette, Code, Rocket, ArrowRight, CheckCircle, Clock, Users, Sparkles, Target, Zap, Shield } from 'lucide-react'
...
export default function ProcessSection() {
  ...
  return (
    <section className="py-20 md:py-24 bg-gray-50 dark:bg-gray-800/30 relative overflow-hidden">
      ...
      {/* Multiple animated gradient orbs with green and orange theme */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-green-400/10 via-emerald-400/10 to-orange-400/10 rounded-full filter blur-3xl transform translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-orange-400/10 via-green-400/10 to-emerald-400/10 rounded-full filter blur-3xl transform -translate-x-1/2 translate-y-1/2 animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-gradient-to-br from-yellow-400/5 via-orange-400/5 to-green-400/5 rounded-full filter blur-3xl transform -translate-x-1/2 -translate-y-1/2 animate-pulse delay-500"></div>
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
                  ...
                  return (
                    <button
                      ...
                      className={`relative py-6 px-4 text-center transition-all duration-300 group ${
                        ...
                        index < activeStep ? 'bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20' : ''
                      }`}
                    >
                      ...
                      {index === activeStep && (
                        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-green-500 to-orange-500 rounded-t-full"></div>
                      )}
                    </button>
                  )
                })}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="flex items-center justify-center">
                  <div className="relative w-full max-w-md">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-green-100 via-emerald-100 to-orange-100 dark:from-green-900/20 dark:via-emerald-900/20 dark:to-orange-900/20 rounded-3xl transform rotate-3"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-100 via-green-100 to-emerald-100 dark:from-orange-900/20 dark:via-green-900/20 dark:to-emerald-900/20 rounded-3xl transform -rotate-3"></div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
            آماده‌اید تا پروژه بعدی خود را با هم شروع کنیم؟
          </p>
        </div>
      </div>
    </section>
